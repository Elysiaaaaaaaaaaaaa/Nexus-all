...
export const workflowAPI = {
  // 处理用户工作流请求
  processWork: async (projectName, userInput, mode = 'production', videoDuration = null, modifyNum = []) => {
    const requestBody = {
      project_name: projectName,
    ...
    if (Array.isArray(modifyNum) && modifyNum.length > 0) {
      requestBody.modify_num = modifyNum;
    }
