        ...
        <div className="settings-inner">
          ...
          <section className="settings-section">
            <div className="section-header">
              ...
              <h2 className="section-title">{t('settings.sectionModel')}</h2>
            </div>

            <div className="settings-form">
              <div className="form-grid">
                <div className="form-field">
                  <label className="form-label">{t('settings.primaryModel')}</label>
                ...
                <div className="form-field">
                  <label className="form-label">{t('settings.reasoning')}</label>
                  <div className="form-select-wrapper">
                    <select 
                      className="form-select"
                    ...
                    >
                      <option>{t('settings.reasoningHigh')}</option>
                      <option>{t('settings.reasoningBalanced')}</option>
                      <option>{t('settings.reasoningLow')}</option>
                    </select>
                    <CaretDown className="form-select-arrow" size={16} />
                  </div>
                </div>
              ...
              <div className="form-field">
                <div className="slider-container">
                  <div className="slider-header">
                    <label className="form-label">{t('settings.creativity')}</label>
          ...
          <section className="settings-section">
            <div className="section-header">
              ...
              <h2 className="section-title">{t('settings.sectionPersona')}</h2>
            </div>
            <div className="form-field">
          ...
          <section className="settings-section">
            <div className="section-header">
              ...
              <h2 className="section-title">{t('settings.sectionInterface')}</h2>
            </div>
            <div className="form-field">
          ...
          <section className="settings-section">
            <div className="section-header">
              ...
              <h2 className="section-title">{t('settings.sectionNotify')}</h2>
            </div>
            <div className="form-field">
              <label className="form-label">{t('settings.emailNotify')}</label>
              <div className="form-select-wrapper">
                <select className="form-select">
                  <option>{t('settings.enable')}</option>
                  <option>{t('settings.disable')}</option>
                </select>
                <CaretDown className="form-select-arrow" size={16} />
              </div>
            </div>
          ...
          <section className="settings-section">
            ...
            <div className="form-field">
              <label className="form-label">{t('settings.twoFactor')}</label>
              <div className="form-select-wrapper">
                <select className="form-select">
          ...
          <section className="danger-zone">
            <h2 className="danger-zone-header">
              <WarningCircle weight="bold" size={18} /> {t('settings.danger')}
            </h2>
            <div className="danger-zone-content">
              <div className="danger-zone-info">
                <h3>{t('settings.clearHistory')}</h3>
                <p>{t('settings.irreversible')}</p>
              </div>
              <button 
