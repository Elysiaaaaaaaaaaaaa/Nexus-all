export const messages = {
  'zh-CN': {
    ...
    homepage: {
      ...
      runtimeChannelWechat: '微信小程序',
      runtimeChannelWechatHint: '当前为微信小程序内嵌 H5 或独立小程序构建',
  ...
  'en-US': {
    ...
    homepage: {
      ...
      runtimeChannelWechat: 'WeChat Mini Program',
      runtimeChannelWechatHint: 'Embedded H5 in WeChat or mini-program build',
  ...
  'ja-JP': {
    ...
    homepage: {
      ...
      runtimeChannelWechat: 'WeChat ミニプログラム',
      runtimeChannelWechatHint: 'WeChat 内 H5 またはミニプログラム向けビルド',
